...
import org.example.chess.util.LegalMovesInCheckHelper;
import org.example.chess.util.LegalMovesOutOfCheckHelper;
...
public class CheckMoveHandler {
    ...
    private final CheckmateHandler checkmateHandler;
